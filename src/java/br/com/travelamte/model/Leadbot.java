...
public class Leadbot {
    ...
    public String getUnidadetravelmate() {
        return unidadetravelmate;
    }

    public void setUnidadetravelmate(String unidadetravelmate) {
        this.unidadetravelmate = unidadetravelmate;
    }
